export default function Privacy() {
  return (
    <div className="min-h-screen bg-dark text-dark-600 px-6 py-12">
      <div className="max-w-2xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-white">Política de Privacidade</h1>
          <p className="text-dark-400 text-sm mt-2">adStudioAI — última atualização: 19 de junho de 2026</p>
        </div>
        ...
        <section className="space-y-2">
          ...
          <p className="text-dark-400 text-sm">
            ...
            <a href="mailto:davimvf1234@gmail.com" className="text-brand-400 underline">
